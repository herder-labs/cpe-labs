...
//
// All four DeviceIDPaths fields are required — the inform package
// ships no TR-181 / TR-098 / vendor-specific defaults, per CLAUDE.md
// anchor #3 (behavior is config, not code). Operators declare which
