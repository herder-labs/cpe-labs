...
func (e *Encoder) WriteFault(h Header, f Fault) error {
	...
	if err := e.writeString("  <%s:Body>\n    <%s:Fault>\n      <faultcode>Client</faultcode>\n      <faultstring>CWMP fault</faultstring>\n      <detail>\n        <%s:Fault>\n          <FaultCode>%d</FaultCode>\n          <FaultString>%s</FaultString>\n        </%s:Fault>\n      </detail>\n    </%s:Fault>\n  </%s:Body>\n",
		soap, soap, cwmp, f.FaultCode, escapeText(f.FaultString), cwmp, soap, soap); err != nil {
		return err
	}
...
<%s:Envelope xmlns:%s="%s" xmlns:%s="%s" xmlns:%s="%s" xmlns:xsd="%s">
`, soap, soap, envelopeNS, cwmp, e.opts.Version, xsi, xsiNS, xsdNS)
}
