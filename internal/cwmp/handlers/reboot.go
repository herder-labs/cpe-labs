...
// #26 — preserves backward compatibility for callers that have not
// been wired up to the eventSchedule profile block (#53).
...
//
// Per CLAUDE.md anchor #1, the simulator does not actually reboot;
